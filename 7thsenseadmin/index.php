...
else
{
	...
	$query = "SELECT `email`,`password` FROM $dbtbl_admin_details WHERE `email` = '$email' AND `password` = '$password'";
...
<html lang="en">
<head>
    <title>Admin Login - Seventh Sense 2010</title>
    <style>
    legend {
    font-family:"Verdana";
    font-size: 14px;
	...
	<table border="0">
		<tr>
			<td colspan="2" style="text-align:center;">
				<span style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:20px; color:#006633"><span style="color:#003399;">7th-Sense :</span> Admin Login</span><hr/>
			</td>
		</tr>
		<tr>
			<td width="100px">
