...
else
{
	if(isset($_GET['email']))
	{
    	...
    	$query = "SELECT * FROM $dbtbl_reg_details WHERE `email` = '$email'";
...
<html lang="en">
<head>
	<title>Equiry - Online Registartions - 7th Sense</title>
	<style type="text/css">
	body {
		margin: 0px;
...
<body>
	<div id="wrapper">
		<div id="header">
			...
			<h1><span style="font-family:Verdana;font-size:20px; color:#006633"><span style="color:#003399;">Equiry - Online Registartions -</span> 7th Sense</span></h1>
		</div>
		<div id="details_table">
				...
				<tr>
					<td>
						<span class="form_fields">First Name</span>
					</td>
					<td>
				...
				<tr>
					<td>
						<span class="form_fields">Last Name</span>
					</td>
					<td>
