...
else
{
	if(isset($_GET['phone']))
	{
    	...
    	$query = "SELECT * FROM $dbtbl_mobile_participant_details WHERE `phone` = '$phone'";
...
<body>
	<div id="wrapper">
		<div id="header">
			...
			<h1><span style="font-family:Verdana;font-size:20px; color:#006633"><span style="color:#003399;">Equiry - Mobile Registartions -</span> 7th Sense</span></h1>
		</div>
...
<body>
	<div id="wrapper">
		...
		<div id="details_table" style="text-align:center;width:100%;margin:0px auto;">
			<form name="email_equiry_form" method="get" action="" autocomplete="off" style="width:400px;margin:0px auto;">
				<table>
				<tr>
					<td>
						Mobile No:&nbsp;&nbsp;
					...
					<td>
						+91- <input type="text" name="phone" maxlength="10" style="width:180px;"/>
					</td>
				</tr>
